    ...
    <div className={`overlay${open ? ' is-open' : ''}`} aria-hidden={!open}>
      ...
      <div className="overlay-body">
        <ul className="overlay-nav">
          ...
          <li><Link href="/sections/short-squeez/" onClick={onClose}><span className="num">07</span><span>Short <em>Squeez</em></span><span className="arrow">→</span></Link></li>
          <li><Link href="/sections/skift/" onClick={onClose}><span className="num">08</span><span>Skift <em>Daily</em></span><span className="arrow">→</span></Link></li>
        </ul>
      </div>
